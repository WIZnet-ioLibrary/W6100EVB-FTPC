...
wiz_NetInfo gWIZNETINFO = { .mac = {0x00, 0x08,0xdc,0x57,0x57,0x61},
                            .ip = {192, 168, 100, 61},
                            .sn = {255, 255, 0, 0},
                            .gw = {192, 168, 100, 1},
                            .dns = {192, 168, 100, 1},
...
int main(void)
{
    ...
    uint8_t FTP_destip6[16] = {0x20,0x01, 0x02,0xb8,  // For FTP IPv6 client examples; destination network info
                            0x00,0x10, 0xff,0xfe,
                            0x31,0x71,0x98,0x05,
                            0x70,0x24,0x4b,0xb1
                                                    };
